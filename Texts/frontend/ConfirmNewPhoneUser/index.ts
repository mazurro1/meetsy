const Texts = {
  pl: {
    ...
    buttonSave: "Zapisz",
    sendCodeAgain: "Wyślij ponownie kod",
    ...
    codeChangeOneInHour: "Numer telefonu można zmienić 1 raz w ciągu godziny.",
    resetPhoneNumber: "Resetuj numer telefonu",
  },
  en: {
    title: "Confirm the new phone number",
    ...
    codeChangeOneInHour: "The telephone number can be changed 1 time per hour.",
