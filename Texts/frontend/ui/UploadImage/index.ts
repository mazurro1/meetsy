const Texts = {
  pl: {
    ...
    errorTypeImage: "Błędny typ pliku. Akceptowane rozszeżenia: png, jpg, jpeg",
  ...
  en: {
    ...
    errorAddedImage: "Error while adding a photo",
    errorTypeImage: "Wrong file type. Accepted extensions: png, jpg, jpeg",
