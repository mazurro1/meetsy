...
import {
  changeComapnyAdmin,
  updateWorkerPermissionsAdmin,
} from "pageApiActions/admin/companys/workers/permissions";
  ...
  switch (method) {
    case "POST": {
      if (!!userEmail && !!companyId) {
        ...
        return await changeComapnyAdmin(
          userEmail,
          data.workerEmail,
          data.adminPassword,
          companyId,
    ...
    case "PATCH": {
      if (!!userEmail && !!companyId) {
        ...
        return await updateWorkerPermissionsAdmin(
          userEmail,
          data.workerEmail,
          data.adminPassword,
          data.permissions,
