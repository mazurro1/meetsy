  ...
  if (phase === PHASE_DEVELOPMENT_SERVER) {
    return {
      env: {
        ...
        NEXTAUTH_URL_TOKEN_SECREET:
          "Qgs2w1GyMXClRt6NTppZEouawsa2wN5kFf0Sis2xeH4=",
        NEXTAUTH_GOOGLE_CLIENT:
          "241873345529-krev89do1rkuc6mu6gr0fec99jscgfgf.apps.googleusercontent.com",
        NEXTAUTH_GOOGLE_SECRET: "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",
        NEXTAUTH_FACEBOOK_CLIENT: "661499325296053",
        NEXTAUTH_FACEBOOK_SECRET: "c4776bc67105572002fd0aefd62d1602",
      },
      experimental: {
